...
(function() {
  ...
  _loadStreams = function(result) {
    return new Promise(function(resolve, reject) {
      var dataLoader, done, finished, list, maybeResolve, objectLoader, started;
      done = false;
      if (result.dataStream != null) {
        ...
        objectLoader = through2.obj(function(object, encoding, callback) {
          var index;
          index = started;
          started++;
          _loadStreams(object).then(function(result) {
  ...
  getObjects = function(resourceType, objectType, ids, options) {
